...
import '../Categories/DiseaseCategory/categories.dart'; // Placeholder for the NewScreen import
import '../Doctors//DoctorDetailsScreen.dart';
import '../BottomNavbar/message.dart'; // Importing the new MessageScreen
import 'dart:async';
import '../BottomNavbar/reels.dart';
import '../BottomNavbar/profile.dart';
import '../Categories/PhysicalFitness/physical_health.dart';
                ...
                onTap: () {
                  if (categories[index]['title'] == 'Physical Health') {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PhysicalHealthScreen(categoryTitle: "Physical Health"),
                      ),
                    );
                  } else {
                    Navigator.push(
